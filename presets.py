...
TAGS_PROMPT = (
    ...
    "1. Meta & Medium: (Quality tags, art style, e.g., masterpiece, 2d, sketch, flat color)\n"
    "2. Subject Base: (Count, e.g., 1girl, solo, multiple girls)\n"
    "3. Physical Traits: (Hair length/color/style, eye color, skin tone)\n"
    "4. Expression & Face: (e.g., pouting, puffy cheeks, red rimmed eyes, tears, expressionless)\n"
    "5. Attire & Accessories: (Clothing, ribbons, jewelry, footwear)\n"
    "6. Pose & Action: (What are they doing? e.g., sitting, holding phone, looking at viewer)\n"
    "7. Background & Lighting: (Setting, weather, lighting, effects, e.g., simple background, dark room, glitch effect)\n\n"
    "CRITICAL AXIOMS:\n"
    "- ONLY output the comma-separated list. \n"
    "- NO markdown formatting (do not use `**` or code blocks).\n"
    "- NO conversational prefixes or suffixes (do not write 'Tags:', 'Here are the tags', etc.).\n"
    "- Look STRICTLY at the image. Do not blindly copy the examples provided above.\n"
    "Begin your output immediately with the first Meta tag."
)
